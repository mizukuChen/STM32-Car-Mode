...
#define WIN1_Pin GPIO_PIN_2
#define WIN1_GPIO_Port GPIOD
#define HIN1_Pin GPIO_PIN_3
#define HIN1_GPIO_Port GPIOD
#define WIN2_Pin GPIO_PIN_4
#define WIN2_GPIO_Port GPIOD
#define HIN2_Pin GPIO_PIN_5
#define HIN2_GPIO_Port GPIOD
#define WIN3_Pin GPIO_PIN_6
#define WIN3_GPIO_Port GPIOD
#define HIN3_Pin GPIO_PIN_7
#define HIN3_GPIO_Port GPIOD
#define WIN4_Pin GPIO_PIN_3
#define WIN4_GPIO_Port GPIOB
#define HIN4_Pin GPIO_PIN_4
#define HIN4_GPIO_Port GPIOB
