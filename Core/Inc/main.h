...
#define XIN1_GPIO_Port GPIOD
#define YIN1_Pin GPIO_PIN_3
#define YIN1_GPIO_Port GPIOD
#define XIN2_Pin GPIO_PIN_4
#define XIN2_GPIO_Port GPIOD
#define YIN2_Pin GPIO_PIN_5
#define YIN2_GPIO_Port GPIOD
#define XIN3_Pin GPIO_PIN_6
#define XIN3_GPIO_Port GPIOD
#define YIN3_Pin GPIO_PIN_7
#define YIN3_GPIO_Port GPIOD
#define XIN4_Pin GPIO_PIN_3
#define XIN4_GPIO_Port GPIOB
#define YIN4_Pin GPIO_PIN_4
#define YIN4_GPIO_Port GPIOB
